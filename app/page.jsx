      ...
      <div className="min-h-screen relative overflow-hidden bg-[#02030a]">
        ...
        <section className="relative z-10 min-h-screen flex items-center px-8 py-20 bg-[#02030a]">
          <div className="w-full relative">
            ...
            <div className="absolute left-24 top-1/2 -translate-y-1/2 z-30 max-w-2xl">
              <h2 className="text-5xl font-normal text-white mb-12">
                Обо мне
              </h2>
              <div className="w-24 h-1 bg-gradient-to-r from-blue-400 via-cyan-500 to-teal-500 mb-12"></div>
