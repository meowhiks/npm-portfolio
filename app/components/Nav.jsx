    ...
    <nav className="fixed top-8 left-0 right-0 z-50 flex justify-center">
      <div className="bg-white/5 backdrop-blur-md rounded-xl flex items-center gap-6" style={{ padding: '5px 20px' }}>
        ...
        >
          ...
          <span className="inline-block max-w-0 opacity-0 overflow-hidden whitespace-nowrap transition-all duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ml-0 text-lg align-middle group-hover:max-w-[150px] group-hover:opacity-100 group-hover:ml-2 whitespace-nowrap text-2xl">Switch theme</span>
        </button>
        ...
        >
          ...
          <span className="inline-block max-w-0 opacity-0 overflow-hidden whitespace-nowrap transition-all duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ml-0 text-lg align-middle group-hover:max-w-[150px] group-hover:opacity-100 group-hover:ml-2 whitespace-nowrap text-2xl">Change Language</span>
        </button>
